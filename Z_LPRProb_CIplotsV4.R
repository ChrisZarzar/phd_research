...
dir.create(paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_percent_classifications/outimgs/',sep=''), showWarnings = FALSE)


file.names <- c('bv_3class', 'rad_3class', 'ref_3class')
for (fname in file.names){
## List and sort the files
file.cmd <- paste('files <- file.info(list.files(path="C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_percent_classifications/',fname,'", pattern="*.txt", full.names = TRUE, recursive = FALSE))', sep='')
...
count <- 0
  ...
  outPut.cmd <- paste('png(file="C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_percent_classifications/outimgs/Logit_',fname,'.png")',sep='')
  ...
  outPut.cmd <- paste('png(file ="C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_percent_classifications/outimgs/NeuralNetwork_',fname,'.png")',sep='')
  eval(parse(text=outPut.cmd))
  plotmat <- plotmatneu
  ...
  outPut.cmd <- paste('png(file ="C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_percent_classifications/outimgs/randomTrees_',fname,'.png")',sep='')
  eval(parse(text=outPut.cmd))
  plotmat <- plotmatran
  ...
  outPut.cmd <- paste('png(file ="C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_percent_classifications/outimgs/maximumLikelihood_',fname,'.png")',sep='')
  eval(parse(text=outPut.cmd))
  plotmat <- plotmatmax
  ...
  outPut.cmd <- paste('png(file ="C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_percent_classifications/outimgs/supportVector_',fname,'.png")',sep='')
  eval(parse(text=outPut.cmd))
  plotmat <- plotmatsup
