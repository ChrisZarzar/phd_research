...
for (i in 1:length(classMethod)){
  ...
  if (k==1){
    write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_classification_output/bv_2class/',classMethod[i],j,'.txt', sep=''), append = TRUE, sep = ",")
  }
  write(paste(classMethod[i],j,kappa,overallAccuracy, sep =','), file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_classification_output/bv_2class/',classMethod[i],j,'.txt', sep=''), append = TRUE, sep = ",")
  }
}
}
closeAllConnections()
...
for (i in 1:length(classMethod)){
  ...
  for (j in seq(0.05,1,.05)){
    for (k in 1:1000){
      ...
      accuracyMatrix <- outlist[[classMethod[i]]]@accuracyMatrix
      if (k==1){
        write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_classification_output/rad_2class/',classMethod[i],j,'.txt', sep=''), append = TRUE, sep = ",")
      }
      write(paste(classMethod[i],j,kappa,overallAccuracy, sep =','), file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_classification_output/rad_2class/',classMethod[i],j,'.txt', sep=''), append = TRUE, sep = ",")
    }
  }
}
closeAllConnections()
...
for (i in 1:length(classMethod)){
  ...
  for (j in seq(0.05,1,.05)){
    for (k in 1:1000){
      ...
      accuracyMatrix <- outlist[[classMethod[i]]]@accuracyMatrix
      if (k==1){
        write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_classification_output/ref_2class/',classMethod[i],j,'.txt', sep=''), append = TRUE, sep = ",")
      }
      write(paste(classMethod[i],j,kappa,overallAccuracy, sep =','), file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_classification_output/ref_2class/',classMethod[i],j,'.txt', sep=''), append = TRUE, sep = ",")
    }
  }
}
closeAllConnections()
