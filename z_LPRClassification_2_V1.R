...
## Redirect output
sink.cmd <- paste('sink("/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/bv_3class/classificationOutput.txt")',sep='')
...
for (k in 1:length(classMethod)){
  ...
  for (i in 1:length(nSamp)){
    ...
    augbv.samp <- rbind(Aqua.samp, Land.samp, Wat.samp)
    ...
    object <- new('rasclass')
    object <- setRasclassData(newdata, ncols = 3*nSamp[i], nrows = 1,
    ...
    print(paste("Classifying for class method " , classMethod[k], " with ", nSamp[i], " samples"))
        ...
        if (j==1){
          write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/bv_3class/',classMethod[k],nSamp[i],'.txt', sep=''), append = TRUE, sep = ",")
        }
        write(paste(classMethod[k],0.7,kappa,overallAccuracy, sep =','), file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/bv_3class/',classMethod[k],nSamp[i],'.txt', sep=''), append = TRUE, sep = ",")
      }
  }
}
closeAllConnections()
...
## Redirect output
sink.cmd <- paste('sink("/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/rad_3class/classificationOutput.txt")',sep='')
eval(parse(text=sink.cmd))
...
for (k in 1:length(classMethod)){
  ...
  for (i in 1:length(nSamp)){
    ...
    augrad.samp <- rbind(Aqua.samp, Land.samp, Wat.samp)
    ...
    print(paste("Classifying for class method " , classMethod[k], " with ", nSamp[i], " samples"))
        ...
        accuracyMatrix <- outlist[[classMethod[k]]]@accuracyMatrix
        if (j==1){
          write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/rad_3class/',classMethod[k],nSamp[i],'.txt', sep=''), append = TRUE, sep = ",")
        }
        write(paste(classMethod[k],0.7,kappa,overallAccuracy, sep =','), file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/rad_3class/',classMethod[k],nSamp[i],'.txt', sep=''), append = TRUE, sep = ",")
      }
  }
}
closeAllConnections()
...
## Redirect output
sink.cmd <- paste('sink("/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/ref_3class/classificationOutput.txt")',sep='')
eval(parse(text=sink.cmd))
...
for (k in 1:length(classMethod)){
  ...
  for (i in 1:length(nSamp)){
    ...
    augref.samp <- rbind(Aqua.samp, Land.samp, Wat.samp)
    ...
    print(paste("Classifying for class method " , classMethod[k], " with ", nSamp[i], " samples"))
        ...
        accuracyMatrix <- outlist[[classMethod[k]]]@accuracyMatrix
        if (j==1){
          write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/ref_3class/',classMethod[k],nSamp[i],'.txt', sep=''), append = TRUE, sep = ",")
        }
        write(paste(classMethod[k],0.7,kappa,overallAccuracy, sep =','), file =paste('/home/chriszarzar/Desktop/RWorkspace/lpr/lpr_sampSize_classifications/ref_3class/',classMethod[k],nSamp[i],'.txt', sep=''), append = TRUE, sep = ",")
      }
  }
}
closeAllConnections()
