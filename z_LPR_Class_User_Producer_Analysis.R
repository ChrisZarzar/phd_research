...
# bv.data <- read.csv("/home/chriszarzar/Desktop/RWorkspace/datasets/aug2015BV25_2class.csv", header = TRUE)
# ad.data <- read.csv("/home/chriszarzar/Desktop/RWorkspace/datasets/aug2015Rad25_2class.csv", header = TRUE)
# augref.data <- read.csv("/home/chriszarzar/Desktop/RWorkspace/datasets/aug2015Ref25_2class.csv", header = TRUE)
augbv.data <- read.csv("C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/datasets/aug2015BV25_2class.csv", header = TRUE)
augrad.data <- read.csv("C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/datasets/aug2015Rad25_2class.csv", header = TRUE)
augref.data <- read.csv("C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/datasets/aug2015Ref25_2class.csv", header = TRUE)
...
## Redirect output
sink.cmd <- paste('sink("C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/bv_2class/classificationOutput.txt")',sep='')
...
for (k in 1:length(classMethod)){
  ...
  object <- new('rasclass')
  object <- setRasclassData(newdata, ncols = 2*nSamp, nrows = 1,
  ...
  write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/bv_2class/',classMethod[k],nSamp,'.txt', sep=''), append = TRUE, sep = ",")
  write(paste(classMethod[k],0.7,kappa,overallAccuracy, sep =','), file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/bv_2class/',classMethod[k],nSamp,'.txt', sep=''), append = TRUE, sep = ",")
  write.csv(accuracyMatrix, file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/bv_2class/',classMethod[k],nSamp,'matrix.csv', sep=''))
}
closeAllConnections()
...
## Redirect output
sink.cmd <- paste('sink("C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/rad_2class/classificationOutput.txt")',sep='')
eval(parse(text=sink.cmd))
...
for (k in 1:length(classMethod)){
  ...
  overallAccuracy <- outlist[[classMethod[k]]]@overallAccuracy
  accuracyMatrix <- outlist[[classMethod[k]]]@accuracyMatrix
  write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/rad_2class/',classMethod[k],nSamp,'.txt', sep=''), append = TRUE, sep = ",")
  write(paste(classMethod[k],0.7,kappa,overallAccuracy, sep =','), file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/rad_2class/',classMethod[k],nSamp,'.txt', sep=''), append = TRUE, sep = ",")
  write.csv(accuracyMatrix, file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/rad_2class/',classMethod[k],nSamp,'matrix.csv', sep=''))
}
closeAllConnections()
...
## Redirect output
sink.cmd <- paste('sink("C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/ref_2class/classificationOutput.txt")',sep='')
eval(parse(text=sink.cmd))
...
for (k in 1:length(classMethod)){
  ...
  overallAccuracy <- outlist[[classMethod[k]]]@overallAccuracy
  accuracyMatrix <- outlist[[classMethod[k]]]@accuracyMatrix
  write("Class_Method,Split_Frac,Kappa,Overall_Acc", file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/ref_2class/',classMethod[k],nSamp,'.txt', sep=''), append = TRUE, sep = ",")
  write(paste(classMethod[k],0.7,kappa,overallAccuracy, sep =','), file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/ref_2class/',classMethod[k],nSamp,'.txt', sep=''), append = TRUE, sep = ",")
  write.csv(accuracyMatrix, file =paste('C:/Users/chris/OneDrive/Desktop/Research/RWorkspace/lpr/lpr_classification_output/ref_2class/',classMethod[k],nSamp,'matrix.csv', sep=''))
}
closeAllConnections()
