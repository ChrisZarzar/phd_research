...
source('E:/Research/RWorkspace/rcodes/plot.ci.R')


# Read in the data
panel06.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined06%_Canon.csv", header = TRUE)
panel22.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined22%_Canon.csv", header = TRUE)
panel44.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined44%_Canon.csv", header = TRUE)

# Output all returned values to text file
sink("E:/Research/RWorkspace/NorthFarm_output/NorthFarmTest_Canon.txt")
...
eval(parse(text=plotmat.cmd))
    ...
    #Plot the CIs
    png(file =paste('E:/Research/RWorkspace/NorthFarm_output/NorthFarmPlots_Canon_',band[k],'_',tarp[j], '.png', sep=''))
    plotmat <- plotmat[,-1]
    ...
    axis(1, at=1:9, labels=xrange, cex.axis=2, las=2)
...
# Read in the data
panel06.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined06%_Phantom.csv", header = TRUE)
panel22.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined22%_Phantom.csv", header = TRUE)
panel44.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined44%_Phantom.csv", header = TRUE)

# Output all returned values to text file
sink("E:/Research/RWorkspace/NorthFarm_output/NorthFarmTest_Phantom.txt")
#pdf(file = "E:/Research/RWorkspace/NorthFarmPlots_Canon.pdf")
...
for (k in 1:length(band.col)){
  for(j in 1:length(tarp)){
    ...
    #Plot the CIs
    png(file =paste('E:/Research/RWorkspace/NorthFarm_output/NorthFarmPlots_Phantom_',band[k],'_',tarp[j], '.png', sep=''))
    plotmat <- plotmat[,-1]
    xrange <- c(30,(seq(100,400,by=100)))
    #yrange <- seq(10000,80000,by=10000)
    barwidth=0.2
    plot.title <- paste(band[k],' Band ',tarp[j], '% Panel', sep='')
    n.plots <- length(plotmat[1,])
    ...
    axis(1, at=1:5, labels=xrange, cex.axis=2, las=2)
    abline(h=plotmat[2,1], col="blue")
    abline(h=plotmat[1,1],lty= 2, col="red")
    abline(h=plotmat[3,1],lty= 2, col="red")
    dev.off()
...
# Read in the data
panel06.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined06%_MicaSense.csv", header = TRUE)
panel22.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined22%_MicaSense.csv", header = TRUE)
panel44.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudesCombined44%_MicaSense.csv", header = TRUE)

# Output all returned values to text file
sink("E:/Research/RWorkspace/NorthFarm_output/NorthFarmTest_Mica.txt")
...
for (k in 1:length(band.col)){
  for(j in 1:length(tarp)){
    ...
    #Plot the CIs
    png(file =paste('E:/Research/RWorkspace/NorthFarm_output/NorthFarmPlots_Mica_',band[k],'_',tarp[j], '.png', sep=''))
    plotmat <- plotmat[,-1]
    xrange <- c(30,(seq(100,800,by=100)))
    yrange <- seq(10000,80000,by=10000)
    barwidth=0.2
