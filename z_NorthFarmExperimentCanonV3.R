...
# Read in the data
panel06.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudeCombined06%_Canon.csv", header = TRUE)
panel22.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudeCombined22%_Canon.csv", header = TRUE)
panel44.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudeCombined44%_Canon.csv", header = TRUE)

# Output all returned values to text file
sink("E:/Research/RWorkspace/NorthFarmTest_Canon.txt")
...
eval(parse(text=plotmat.cmd))
    ...
    #Plot the CIs
    png(file =paste('E:/Research/RWorkspace/NorthFarmPlots_Canon_',band[k],'_',tarp[j], '.png', sep=''))
    plotmat <- plotmat[,-1]
...
# Read in the data
panel06.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudeCombined06%_Phantom.csv", header = TRUE)
panel22.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudeCombined22%_Phantom.csv", header = TRUE)
panel44.data <- read.csv("E:/Research/RWorkspace/datasets/AltitudeCombined44%_Phantom.csv", header = TRUE)

# Output all returned values to text file
sink("E:/Research/RWorkspace/NorthFarmTest_Phantom.txt")
#pdf(file = "E:/Research/RWorkspace/NorthFarmPlots_Canon.pdf")
