...
#EDITED ON 10-19-2016 CZ: I am trying to set up the script in a loop rather than a bunch of copy and pasting. 


# Read in the data
panel06.data <- read.csv("F:/RWorkspace/datasets/AltitudeCombined06%_Canon.csv", header = TRUE)
panel22.data <- read.csv("F:/RWorkspace/datasets/AltitudeCombined22%_Canon.csv", header = TRUE)
panel44.data <- read.csv("F:/RWorkspace/datasets/AltitudeCombined44%_Canon.csv", header = TRUE)

# Output all returned values to text file
sink("F:/RWorkspace/NorthFarmTest.txt")
pdf(file = "F:/RWorkspace/NorthFarmPlots.pdf")

# Loop through panels to read in the data and calculate confidence intervals
#for (Per in c('06','22','44')){
# Organize the data by altitude

panelPer_0_Green <- ifelse(panelPer.data[,3]<=0,panelPer.data[,5],NA)
panelPer_0_Red <- ifelse(panelPer.data[,3]<=0,panelPer.data[,6],NA)
panelPer_0_NIR <- ifelse(panelPer.data[,3]<=0,panelPer.data[,7],NA)
panelPer_0_Green <- panelPer_0_Green[!is.na(panelPer_0_Green)]
panelPer_0_Red <- panelPer_0_Red[!is.na(panelPer_0_Red)]
panelPer_0_NIR <- panelPer_0_NIR[!is.na(panelPer_0_NIR)]

panelPer_100_Green <- ifelse(panelPer.data[,3]<=100 & panelPer.data[,3]>10,panelPer.data[,5],NA)
panelPer_100_Red <- ifelse(panelPer.data[,3]<=100 & panelPer.data[,3]>10,panelPer.data[,6],NA)
panelPer_100_NIR <- ifelse(panelPer.data[,3]<=100 & panelPer.data[,3]>10,panelPer.data[,7],NA)
panelPer_100_Green <- panelPer_100_Green[!is.na(panelPer_100_Green)]
panelPer_100_Red <- panelPer_100_Red[!is.na(panelPer_100_Red)]
panelPer_100_NIR <- panelPer_100_NIR[!is.na(panelPer_100_NIR)]

panelPer_200_Green <- ifelse(panelPer.data[,3]<=200 & panelPer.data[,3]>100,panelPer.data[,5],NA)
panelPer_200_Red <- ifelse(panelPer.data[,3]<=200 & panelPer.data[,3]>100,panelPer.data[,6],NA)
panelPer_200_NIR <- ifelse(panelPer.data[,3]<=200 & panelPer.data[,3]>100,panelPer.data[,7],NA)
panelPer_200_Green <- panelPer_200_Green[!is.na(panelPer_200_Green)]
panelPer_200_Red <- panelPer_200_Red[!is.na(panelPer_200_Red)]
panelPer_200_NIR <- panelPer_200_NIR[!is.na(panelPer_200_NIR)]

panelPer_300_Green <- ifelse(panelPer.data[,3]<=300 & panelPer.data[,3]>200,panelPer.data[,5],NA)
panelPer_300_Red <- ifelse(panelPer.data[,3]<=300 & panelPer.data[,3]>200,panelPer.data[,6],NA)
panelPer_300_NIR <- ifelse(panelPer.data[,3]<=300 & panelPer.data[,3]>200,panelPer.data[,7],NA)
panelPer_300_Green <- panelPer_300_Green[!is.na(panelPer_300_Green)]
panelPer_300_Red <- panelPer_300_Red[!is.na(panelPer_300_Red)]
panelPer_300_NIR <- panelPer_300_NIR[!is.na(panelPer_300_NIR)]

panelPer_400_Green <- ifelse(panelPer.data[,3]<=400 & panelPer.data[,3]>300,panelPer.data[,5],NA)
panelPer_400_Red <- ifelse(panelPer.data[,3]<=400 & panelPer.data[,3]>300,panelPer.data[,6],NA)
panelPer_400_NIR <- ifelse(panelPer.data[,3]<=400 & panelPer.data[,3]>300,panelPer.data[,7],NA)
panelPer_400_Green <- panelPer_400_Green[!is.na(panelPer_400_Green)]
panelPer_400_Red <- panelPer_400_Red[!is.na(panelPer_400_Red)]
panelPer_400_NIR <- panelPer_400_NIR[!is.na(panelPer_400_NIR)]

panelPer_500_Green <- ifelse(panelPer.data[,3]<=500 & panelPer.data[,3]>400,panelPer.data[,5],NA)
panelPer_500_Red <- ifelse(panelPer.data[,3]<=500 & panelPer.data[,3]>400,panelPer.data[,6],NA)
panelPer_500_NIR <- ifelse(panelPer.data[,3]<=500 & panelPer.data[,3]>400,panelPer.data[,7],NA)
panelPer_500_Green <- panelPer_500_Green[!is.na(panelPer_500_Green)]
panelPer_500_Red <- panelPer_500_Red[!is.na(panelPer_500_Red)]
panelPer_500_NIR <- panelPer_500_NIR[!is.na(panelPer_500_NIR)]

panelPer_600_Green <- ifelse(panelPer.data[,3]<=600 & panelPer.data[,3]>500,panelPer.data[,5],NA)
panelPer_600_Red <- ifelse(panelPer.data[,3]<=600 & panelPer.data[,3]>500,panelPer.data[,6],NA)
panelPer_600_NIR <- ifelse(panelPer.data[,3]<=600 & panelPer.data[,3]>500,panelPer.data[,7],NA)
panelPer_600_Green <- panelPer_600_Green[!is.na(panelPer_600_Green)]
panelPer_600_Red <- panelPer_600_Red[!is.na(panelPer_600_Red)]
panelPer_600_NIR <- panelPer_600_NIR[!is.na(panelPer_600_NIR)]

panelPer_700_Green <- ifelse(panelPer.data[,3]<=700 & panelPer.data[,3]>600,panelPer.data[,5],NA)
panelPer_700_Red <- ifelse(panelPer.data[,3]<=700 & panelPer.data[,3]>600,panelPer.data[,6],NA)
panelPer_700_NIR <- ifelse(panelPer.data[,3]<=700 & panelPer.data[,3]>600,panelPer.data[,7],NA)
panelPer_700_Green <- panelPer_700_Green[!is.na(panelPer_700_Green)]
panelPer_700_Red <- panelPer_700_Red[!is.na(panelPer_700_Red)]
panelPer_700_NIR <- panelPer_700_NIR[!is.na(panelPer_700_NIR)]

panelPer_800_Green <- ifelse(panelPer.data[,3]<=800 & panelPer.data[,3]>700,panelPer.data[,5],NA)
panelPer_800_Red <- ifelse(panelPer.data[,3]<=800 & panelPer.data[,3]>700,panelPer.data[,6],NA)
panelPer_800_NIR <- ifelse(panelPer.data[,3]<=800 & panelPer.data[,3]>700,panelPer.data[,7],NA)
panelPer_800_Green <- panelPer_800_Green[!is.na(panelPer_800_Green)]
panelPer_800_Red <- panelPer_800_Red[!is.na(panelPer_800_Red)]
panelPer_800_NIR <- panelPer_800_NIR[!is.na(panelPer_800_NIR)]

# Run bootstrap confidence interval on data for 6% panel

boot.Per_0.Green <- boot(panelPer_0_Green,mean.boot,R=1000)
boot.Per_0.Red <- boot(panelPer_0_Red,mean.boot,R=1000)
boot.Per_0.NIR <- boot(panelPer_0_NIR,mean.boot,R=1000)
ci.Per_0.Green <- quantile(boot.Per_0.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_0.Red <- quantile(boot.Per_0.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_0.NIR <- quantile(boot.Per_0.NIR$t,probs=c(0.025,0.5,0.975)) 

boot.Per_100.Green <- boot(panelPer_100_Green,mean.boot,R=1000)
boot.Per_100.Red <- boot(panelPer_100_Red,mean.boot,R=1000)
boot.Per_100.NIR <- boot(panelPer_100_NIR,mean.boot,R=1000)
ci.Per_100.Green <- quantile(boot.Per_100.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_100.Red <- quantile(boot.Per_100.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_100.NIR <- quantile(boot.Per_100.NIR$t,probs=c(0.025,0.5,0.975)) 

boot.Per_200.Green <- boot(panelPer_200_Green,mean.boot,R=1000)
boot.Per_200.Red <- boot(panelPer_200_Red,mean.boot,R=1000)
boot.Per_200.NIR <- boot(panelPer_200_NIR,mean.boot,R=1000)
ci.Per_200.Green <- quantile(boot.Per_200.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_200.Red <- quantile(boot.Per_200.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_200.NIR <- quantile(boot.Per_200.NIR$t,probs=c(0.025,0.5,0.975)) 

boot.Per_300.Green <- boot(panelPer_300_Green,mean.boot,R=1000)
boot.Per_300.Red <- boot(panelPer_300_Red,mean.boot,R=1000)
boot.Per_300.NIR <- boot(panelPer_300_NIR,mean.boot,R=1000)
ci.Per_300.Green <- quantile(boot.Per_300.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_300.Red <- quantile(boot.Per_300.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_300.NIR <- quantile(boot.Per_300.NIR$t,probs=c(0.025,0.5,0.975)) 

boot.Per_400.Green <- boot(panelPer_400_Green,mean.boot,R=1000)
boot.Per_400.Red <- boot(panelPer_400_Red,mean.boot,R=1000)
boot.Per_400.NIR <- boot(panelPer_400_NIR,mean.boot,R=1000)
ci.Per_400.Green <- quantile(boot.Per_400.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_400.Red <- quantile(boot.Per_400.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_400.NIR <- quantile(boot.Per_400.NIR$t,probs=c(0.025,0.5,0.975)) 

boot.Per_500.Green <- boot(panelPer_500_Green,mean.boot,R=1000)
boot.Per_500.Red <- boot(panelPer_500_Red,mean.boot,R=1000)
boot.Per_500.NIR <- boot(panelPer_500_NIR,mean.boot,R=1000)
ci.Per_500.Green <- quantile(boot.Per_500.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_500.Red <- quantile(boot.Per_500.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_500.NIR <- quantile(boot.Per_500.NIR$t,probs=c(0.025,0.5,0.975)) 

boot.Per_600.Green <- boot(panelPer_600_Green,mean.boot,R=1000)
boot.Per_600.Red <- boot(panelPer_600_Red,mean.boot,R=1000)
boot.Per_600.NIR <- boot(panelPer_600_NIR,mean.boot,R=1000)
ci.Per_600.Green <- quantile(boot.Per_600.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_600.Red <- quantile(boot.Per_600.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_600.NIR <- quantile(boot.Per_600.NIR$t,probs=c(0.025,0.5,0.975)) 

boot.Per_700.Green <- boot(panelPer_700_Green,mean.boot,R=1000)
boot.Per_700.Red <- boot(panelPer_700_Red,mean.boot,R=1000)
boot.Per_700.NIR <- boot(panelPer_700_NIR,mean.boot,R=1000)
ci.Per_700.Green <- quantile(boot.Per_700.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_700.Red <- quantile(boot.Per_700.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_700.NIR <- quantile(boot.Per_700.NIR$t,probs=c(0.025,0.5,0.975)) 

boot.Per_800.Green <- boot(panelPer_800_Green,mean.boot,R=1000)
boot.Per_800.Red <- boot(panelPer_800_Red,mean.boot,R=1000)
boot.Per_800.NIR <- boot(panelPer_800_NIR,mean.boot,R=1000)
ci.Per_800.Green <- quantile(boot.Per_800.Green$t,probs=c(0.025,0.5,0.975)) 
ci.Per_800.Red <- quantile(boot.Per_800.Red$t,probs=c(0.025,0.5,0.975)) 
ci.Per_800.NIR <- quantile(boot.Per_800.NIR$t,probs=c(0.025,0.5,0.975)) 
...
boot.22_0.Green <- boot(panel22_0_Green,mean.boot,R=1000)
...
boot.22_700.Green <- boot(panel22_700_Green,mean.boot,R=1000)
...
boot.44_0.Green <- boot(panel44_0_Green,mean.boot,R=1000)
...
boot.44_700.Green <- boot(panel44_700_Green,mean.boot,R=1000)
